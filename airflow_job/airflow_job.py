...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="air-flow-projects-gds")
    bq_project = Variable.get("bq_project", default_var="hive-project-436721")
    ...
    file_sensor = GCSObjectExistenceSensor(
        ...
        bucket=gcs_bucket,
        object=f"air-flow-project-1/source-{env}/flight_booking.csv",  # Full file path in GCS
    ...
    batch_details = {
        "pyspark_batch": {
            "main_python_file_uri": f"gs://{gcs_bucket}/air-flow-project-1/spark-job/spark_transformation_job.py",  # Main Python file
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "277121270061-compute@developer.gserviceaccount.com",
                "network_uri": "projects/hive-project-436721/global/networks/default",
                "subnetwork_uri": "projects/hive-project-436721/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="hive-project-436721",
        region="us-central1",
